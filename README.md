...
├── requirements.txt
├── price_history.csv    # 개별 제품 날짜별 누적 가격 (자동 생성)
├── gpu_group_summary.csv # GPU 모델군별 평균가 누적 (자동 생성)
└── .github/workflows/daily_scrape.yml
```

## 출력 파일

### price_history.csv — 개별 제품
| 컬럼 | 설명 |
|------|------|
| date | 수집 날짜 |
...
### gpu_group_summary.csv — GPU 모델군 평균가
| 컬럼 | 설명 |
|------|------|
| date | 수집 날짜 |
...
- 수집 결과를 price_history.csv, gpu_group_summary.csv 에 누적 커밋
